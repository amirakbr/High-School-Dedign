...
const Header = () => {
    ...
    return(
        <div className={`flex items-center rtl justify-between pt-4 container mx-auto relative ${vazirMatn.className} z-20 sticky top-0`} >
            ...
            <div className="flex p-2 ml-2 transition-all hover:bg-[#ffffff59] rounded-lg cursor-pointer" 
                onClick={(e)=>{
                ...
                <div className="flex flex-col relative w-10 h-7">
