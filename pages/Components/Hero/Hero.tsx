...
import { vazirMatn } from "../Header/Header";
const Hero = () => {
    return (
        <div className={`flex flex-col relative mt-14 overflow-hidden rounded-xl z-10 ${vazirMatn.className}`}>
            <div className="flex flex-col rtl bg-[#80808003] p-2" style={{backdropFilter:`blur(4px)`}}>
                ...
                <p>
                    ...
                    مولای ما حضرت رضا (علیه آلاف التحیه و الثناء) و امام عصر در زمانی کوتاه طی شده است و آنچه که در یک
                    مسیر طبیعی در مدت طولانی باید به نتیجه میرسید در مدت زمان کمی به بهترین نتایج رسید، قطعاً ت الش بی وقفه و
                    مسئولانه جمعی از بهترین و خلا قترین جوانان با نیت های پاک و الهی، این مسیر را هموار کرده است.
                </p>
                <p className="border w-max p-2 px-4 rounded-full text-lg font-semibold mt-4 flex relative overflow-hidden before:w-full before:h-full before:absolute before:top-0 before:right-0 before:bg-gray-300 before:z-[-1] before:scale-x-0 before:origin-right
                cursor-pointer
                transition-all before:transition-all hover:before:scale-x-100">
